    ...
    <div className="bg-[#FFF] w-full min-h-screen flex flex-col items-center">
      ...
      <div className="w-full flex flex-col relative bg-[#FFF] min-h-screen">
        ...
        <div className="w-full relative mt-[-91px]">
          <img src="/Contato_Hero.png" className="w-full h-auto block object-cover" alt="Pratos Terra Verde" />
        </div>

        {/* ====== CONTEÚDO TEXTUAL ====== */}
        <div className="w-full bg-[#FFF] px-[35px] pt-[60px] pb-[80px] flex flex-col items-center">
          <h1 
            className="text-[#5E6649] font-cormorantGaramond text-[20px] font-bold tracking-wider text-center mb-[40px] uppercase"
            style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.1)' }}
          >
            CONECTE-SE COM A TERRA VERDE
          </h1>
          
          <div className="flex flex-col gap-[20px]">
            <p className="text-[#5E6649] font-montserrat text-[15px] font-light leading-[1.6] text-justify">
              Cada peça começa com uma conversa. Entre em contato conosco pelo Instagram @terraverdeceramicas ou pelo WhatsApp (11)99998-1223 para encomendas, informações e projetos especiais.
            </p>
            <p className="text-[#5E6649] font-montserrat text-[15px] font-light leading-[1.6] text-justify">
              Será um prazer compartilhar nossa arte com você.
            </p>
          </div>
        </div>
