...
export default function LinhaCoposECanecas() {
  const [menuOpen, setMenuOpen] = useState(false);

  const produtos = [
    {
      img: '/ImgPratoCavalo.png',
      nome: 'Malha',
      preco: 'R$45,00',
    },
    {
      img: '/ImgPratoHorseVerde.png',
      nome: 'Terra & Folha',
      preco: 'R$560,00',
    },
  ];
    ...
    <div className="bg-[#F2EDE7] w-full min-h-screen flex flex-col items-center">
      <div className="w-full flex flex-col relative bg-[#F2EDE7] min-h-screen">
        ...
        <div className="w-full relative" style={{ aspectRatio: '396/420' }}>
          <img
            src="/C24309d713fa442e9c0d7639ff6dd01f1.png"
            className="w-full h-full object-cover absolute left-0 top-0"
            alt="Linha Copos e Canecas"
          />
