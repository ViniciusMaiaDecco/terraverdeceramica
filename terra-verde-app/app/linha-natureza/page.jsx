...
export default function LinhaNatureza() {
  const [menuOpen, setMenuOpen] = useState(false);

  const produtos = [
    {
      img: '/ImgCentroDeMesa.png',
      nome: 'Centro de Mesa',
      preco: 'R$150,00',
    },
    {
      img: '/ImgPortaGuardanapo.png',
      nome: 'Porta Guardanapo',
      preco: 'R$100,00',
    },
    {
      img: '/ImgIncensario.png',
      nome: 'Incensário Folha',
      preco: 'R$80,00',
    },
    {
      img: '/ImgCentroFolha.png',
      nome: 'Centro de Mesa',
      preco: 'R$150,00',
    },
    {
      img: '/ImgDuasFolhas2.png',
      nome: 'Folha do Jardim',
      preco: 'R$80,00',
    },
    {
      img: '/ImgPratoFolhas.png',
      nome: 'Imago Solidário',
      preco: 'R$150,00',
    },
    {
      img: '/ImgIncensario02.png',
      nome: 'Incensário Folha',
      preco: 'R$80,00',
    },
    {
    ...
    {
      img: '/ImgDuasFolhas.png',
      nome: 'Inventário Folhas',
      preco: 'R$120,00',
    },
    {
      img: '/ImgpratoFolha.png',
      nome: 'Inventário Folhas',
      preco: 'R$120,00',
    },
  ];
        ...
        <div className="w-full flex flex-row items-start px-[20px] py-[28px] gap-[16px] bg-[#F2EDE7]">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <p className="text-[#5E6649] font-cormorantGaramond text-[15px] leading-[1.6]">
              A natureza é a grande artista por trás de cada criação. Nas formas das folhas, encontramos inspiração para transformar beleza natural em peças únicas e atemporais.
            </p>
          </div>
        </div>
            ...
            {produtos.map((produto, i) => (
              <div key={i} className="flex flex-col">
                <img
                  ...
                  alt={produto.nome}
                />
                <p className="text-[#5E6649] font-montserrat text-xs font-semibold mt-[10px]">{produto.nome}</p>
                <p className="text-[#846753] font-inter text-xs font-medium mt-[4px]">{produto.preco}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-[#726D48] w-full flex justify-center">
            <div className="w-full px-[30px] py-[35px] flex justify-between items-start">
              <div className="flex flex-col gap-[8px]">
                ...
                <Link href="/" className="text-[#F2EDE7] font-montserrat text-[16px] cursor-pointer hover:underline">Bowls</Link>
