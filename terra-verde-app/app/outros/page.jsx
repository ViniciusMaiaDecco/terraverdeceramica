...
export default function Outros() {
  ...
  const produtos = [
    ...
    },
    {
      ...
      nome: 'Bowl 1 Folha Verde',
      preco: 'R$120,00',
    },
    {
      img: '/ImgCentroDeMesa(1).png',
      nome: 'Bowl Bruixo',
      preco: 'R$80,00',
    },
    {
      img: '/ImgPortaGuardanapo(1).png',
      nome: 'Bowl Folha Colorida',
      preco: 'R$80,00',
    },
    {
      img: '/ImgCentroFolha(1).png',
      nome: 'Bowl 1 Cavalo',
      preco: 'R$80,00',
    },
    {
      img: '/ImgIncensario(1).png',
      nome: 'Mini Folha Colorida',
      preco: 'R$45,00',
    },
    {
      img: '/ImgCentroDeMesa(2).png',
      nome: 'Bowl Universo',
      preco: 'R$80,00',
    },
    {
      img: '/ImgPortaGuardanapo(2).png',
      nome: 'Nova Folha Scale',
      preco: 'R$80,00',
    },
  ];
    ...
    <div className="bg-[#F2EDE7] w-full min-h-screen flex flex-col items-center">
      <div className="w-full flex flex-col relative bg-[#F2EDE7] min-h-screen">
        ...
        <div className="w-full relative" style={{ aspectRatio: '396/420' }}>
          <img
            src="/5649c09619d34b3e903ddc1f4e9922342.png"
        ...
        {/* GRID DE PRODUTOS */}
        <div className="w-full bg-[#F2EDE7] px-[20px] pt-[28px] pb-[30px]">
