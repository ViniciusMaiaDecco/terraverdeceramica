...
export default function PratosETigelas() {
  ...
  const produtos = [
    ...
    },
    {
      ...
      nome: 'Bowl Folha Verde',
      preco: 'R$150,00',
    },
    {
      img: '/ImgIncensario(1).png',
      nome: 'Bowl Alma da Mata',
      preco: 'R$190,00',
    },
    {
  ...
  return (
    <div className="bg-[#F2EDE7] w-full min-h-screen flex flex-col items-center">
      <div className="w-full flex flex-col relative bg-[#F2EDE7] min-h-screen">
        ...
        {/* HERO */}
        <div className="w-full relative" style={{ aspectRatio: '396/320' }}>
          <img
            src="/PratosEtigelas_Hero.png"
            className="w-full h-full object-cover absolute left-0 top-0"
            alt="Pratos e Tigelas"
          />
          <div className="absolute inset-0 bg-black/25" />
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <h1
              className="text-[#F2EDE7] font-cormorantGaramond text-[52px] font-semibold text-center leading-[1.0] tracking-wide"
              style={{ textShadow: '0px 2px 10px rgba(0,0,0,0.55)' }}
            >
              PRATOS
              <br />
              &amp;
