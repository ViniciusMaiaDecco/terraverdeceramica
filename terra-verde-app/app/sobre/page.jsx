  ...
  return (
    <div className="bg-[#FFF] w-full min-h-screen flex flex-col items-center">
      ...
      <div className="w-full flex flex-col relative bg-[#FFF] min-h-screen">
        ...
        {/* ====== HERO: SOBRE NÓS ====== */}
        <div className="w-full relative h-[300px] mt-[-91px]">
          <img src="/SobreNos_Hero.png" className="w-full h-full object-cover" alt="Natureza Terra Verde" />
          <div className="absolute inset-0 bg-black/10"></div>
          <h1 
            className="absolute bottom-[30px] left-1/2 -translate-x-1/2 text-[#FFF] font-cormorantGaramond text-[28px] font-bold tracking-widest uppercase whitespace-nowrap"
        ...
        {/* ====== GRID DE IMAGENS ====== */}
        <div className="flex flex-col pt-[40px] pb-[60px] gap-[45px] bg-[#FFF]">
          
          {/* Row 1 */}
          <div className="flex items-center">
            <img src="/Sobre_Grid1.png" className="w-[155px] h-[155px] object-cover" alt="Terra Verde Cerâmicas" />
            <p className="flex-1 text-[#5E6649] font-montserrat text-[16px] font-light leading-[1.35] pl-[20px] pr-[30px]">
              A Terra Verde Cerâmicas nasceu do encontro entre arte, arquitetura, design e natureza.
            </p>
          </div>

          {/* Row 2 */}
          <div className="flex items-center">
            <p className="flex-1 text-[#5E6649] font-montserrat text-[16px] font-light text-right leading-[1.35] pr-[20px] pl-[30px]">
              Criamos peças autorais inspiradas nas formas, texturas e movimentos do mundo natural.
            </p>
            <img src="/Sobre_Grid2.png" className="w-[155px] h-[155px] object-cover" alt="Inspiração" />
          </div>

          {/* Row 3 */}
          <div className="flex items-center">
            <img src="/Sobre_Grid3.png" className="w-[155px] h-[155px] object-cover" alt="Detalhes" />
            <p className="flex-1 text-[#5E6649] font-montserrat text-[16px] font-light leading-[1.35] pl-[20px] pr-[30px]">
              Das folhas aos animais, da terra à delicadeza dos detalhes que nos cercam.
            </p>
          </div>
        ...
        <div className="w-full relative h-[240px]">
          {/* Imagem do Banner da Mônica */}
          <img src="/Monica_Hero.png" className="w-full h-full object-cover object-center" alt="Mônica Mansur" />
          <div className="absolute inset-0 bg-black/20"></div>
          <h1 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-cormorantGaramond text-[28px] font-bold tracking-widest uppercase text-center w-full"
            style={{ textShadow: '1px 2px 4px rgba(0,0,0,0.3)' }}
          >
            MÔNICA MANSUR
          </h1>
        ...
        {/* ====== TEXTO INTRO ====== */}
        <div className="w-full bg-[#FFF] px-[35px] pt-[45px] pb-[25px]">
          <p className="text-[#5E6649] font-montserrat text-[16px] font-light leading-[1.5] text-justify text-center">
            Sou arquiteta e urbanista de formação, artista e ceramista, com especialização em revestimentos cerâmicos e gestão de projetos de modelagem.
          </p>
        </div>

        {/* ====== FOTO E TEXTO (FUNDO DUPLO) ====== */}
        <div className="w-full relative flex">
          {/* Fundo duplo da linha para dar o efeito do design */}
          <div className="absolute inset-0 flex flex-col">
            <div className="h-[40px] w-full bg-[#FFF]"></div>
            <div className="flex-1 w-full bg-[#F2EDE7]"></div>
          </div>
          
          {/* Conteudo: Foto na esquerda, texto na direita */}
          <div className="w-full flex relative z-10 pb-[50px]">
            <div className="w-[55%] relative">
               {/* Foto da Mônica */}
               <img src="/Monica_Photo.png" className="w-full h-[360px] object-cover rounded-tr-[30px] rounded-br-[30px] shadow-md" alt="Mônica Mansur trabalhando" />
               {/* Logo Marca d'agua */}
               <div className="absolute bottom-[20px] right-[15px] bg-white w-[35px] h-[45px] flex items-center justify-center rounded-[2px] shadow-sm">
                 <img src="/Logo.png" className="w-[25px] object-contain" alt="Logo Watermark" />
               </div>
            </div>
            <div className="w-[45%] flex items-center pl-[20px] pr-[25px] pt-[80px]">
               <p className="text-[#5E6649] font-montserrat text-[16px] font-light leading-[1.5]">
                 Cada peça nasce do encontro entre técnica, sensibilidade, alma, vivência e poesia.
               </p>
            </div>
          </div>
        </div>
        ...
        {/* ====== TEXTO VERDE ESCURO ====== */}
        <div className="w-full bg-[#5E6649] px-[35px] py-[50px]">
          <p className="text-[#F2EDE7] font-montserrat text-[15px] font-light leading-[1.6]">
            Após uma vivência na França, estabeleci meu ateliê, na cidade de Santana de Parnaíba-SP, onde crio e vendo peças autorais, inspiradas na natureza que me cerca, e nos animais. Compartilho esse fazer manual, por meio de cursos e workshops.
          </p>
        </div>
